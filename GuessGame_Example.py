...
class NumberGuessingGame:
    ...
    def __init__(self):
        ...
        self.LOWER = 1
        self.HIGHER = 100
        # self.MAX_CHANCES = 5   # if we want to add number of total guesses to the game
    ...
    def start(self):
        ...
        chances = 0
        while True:
            # if chances == self.MAX_CHANCES:  # if we want to add number of total guesses to the game
